...
6.  **Logging & Persistence:** ALWAYS log your progress. Update `project.md` and `walkthrough.md` in the PROJECT ROOT continuously. These files serve as the persistent memory of the project across different sessions. Every new session MUST start by reading these files to understand the current state.
